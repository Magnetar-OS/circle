...
**Circle is GPL-3.0-only.** That is the licence of everything in this repository and
...
| Layer | Licence |
|---|---|
| This repository — Circle and its binaries | **GPL-3.0-only** |
...
`LICENSE` is the GPL-3.0 text — the licence of Circle and of the binaries it
